...
# with command line options: None --filein=file:MYFILE_GEN_SIM.root --fileout=MYFILE_GEN_SIM_RAW.root --pileup_input=dbs:/MinBias_TuneA2MB_13TeV-pythia8/Fall13-POSTLS162_V1-v1/GEN-SIM --mc --step=DIGI,L1,DIGI2RAW,HLT:2013,RAW2DIGI,L1Reco --conditions=POSTLS170_V6::All --magField=38T_PostLS1 --geometry=DBExtendedPostLS1 --pileup=CSA14_50ns_PoissonOOT --customise=SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --eventcontent=RAWSIM --datatier=GEN-SIM-RAW --number=5000 --no_exec --python_filename=Hadronizer_SIM_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_70X_cfg.py
...
options.inputFiles = "file:store/aodsim/coNLSP_chargino1400_gluino1700_1_GEN_SIM.root"
options.outputFile = "store/aodsim/coNLSP_chargino1400_gluino1700.root"

options.section = 1
options.maxEvents = -1

options.tag = "1_GEN_SIM_RAW"
